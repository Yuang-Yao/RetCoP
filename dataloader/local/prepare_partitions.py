...
def adequate_20_e_ophta():
    ...
    subpath_images = ["e_optha_EX/EX/", "e_optha_EX/healthy/", "e_optha_MA/MA/", "e_optha_MA/healthy/"]             # bug MA
...
def adequate_30_sustech():
    ...
    data_c5 = pd.read_csv(PATH_DATASETS + path_dataset + image_subpath + "c5_DR_reclassified.csv")                #  5   new label
