...
def process(args):
    ...
    dataloaders = get_loader(dataframes_path=args.dataframes_path_OCT, data_root_path=args.data_root_path,
...
def main():
    ...
    parser.add_argument('--out_path', default=PATH_RESULTS_PRETRAIN_OCT+"FT/", help='output path')
